...
export default function AccountsPage() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      // Lọc theo trò chơi cụ thể
      if (selectedGame !== 'all') {
        filtered = filtered.filter(account => account.game === selectedGame);
      }
      ...
      if (searchTerm.trim()) {
        ...
        filtered = filtered.filter(account =>
          ...
          account.info.toLowerCase().includes(searchLower)
        );
      }
  ...
  }, [selectedCategory, selectedGame, priceRange, sortOrder, searchTerm]);
